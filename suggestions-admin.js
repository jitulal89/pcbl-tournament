(()=>{
  ...
  async function render(){
    ...
    try{
      ...
      const result=await sb.from('player_suggestions').select('id,tournament_id,liked,next_tournament,rating,created_at').order('created_at',{ascending:false});
      ...
      msg(`Could not load suggestions. ${detail}`,'suggestions-error');
  ...
  // app.js calls this after navigation; these listeners cover the initial boot race.
